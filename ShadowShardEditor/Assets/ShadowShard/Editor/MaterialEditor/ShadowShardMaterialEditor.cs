...
namespace ShadowShard.Editor.MaterialEditor
{
    public sealed class ShadowShardMaterialEditor
    {
        ...
        public Vector2Int DrawVector2Int(GUIContent label, MaterialProperty property, Vector2IntRange range, int indentLevel = 0) =>
            _vectorIntEditor.DrawVector2Int(label, property, range, indentLevel);
        
        public Vector3Int DrawVector3Int(GUIContent label, MaterialProperty property, Vector3IntRange range, int indentLevel = 0) =>
        ...
        public Vector2Int DrawMinVector2Int(GUIContent label, MaterialProperty property, Vector2Int min, int indentLevel = 0) =>
            _vectorIntEditor.DrawVector2Int(label, property, Vector2IntRange.ToMaxFrom(min), indentLevel);
        
        public Vector3Int DrawMinVector3Int(GUIContent label, MaterialProperty property, Vector3Int min, int indentLevel = 0) =>
