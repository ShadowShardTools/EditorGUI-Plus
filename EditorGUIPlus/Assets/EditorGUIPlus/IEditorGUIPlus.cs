...
namespace EditorGUIPlus
{
    public interface IEditorGUIPlus
    {
        ...
        bool DrawToggle(GUIContent label, SerializedProperty property, int indentLevel = 0, Action onChangedCallback = null);
        ...
        string DrawTextArea(GUIContent label, SerializedProperty property, int indentLevel = 0, Action onChangedCallback = null);
        string DrawTextArea(SerializedProperty property, int indentLevel = 0, Action onChangedCallback = null);
